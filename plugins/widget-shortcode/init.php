...
class Widget_Shortcode {
	...
	function do_widget( $args ) {
		...
		'before_widget' => '<div class="home-widget row flex-wrap"><div id="' . $container_id . '" class="widget ' . $container_class . '">',
		...
		$before_widget = '<div class="home-widget row flex-wrap '.$instance['widget_size'].'"><div id="' . $container_id . '" class="widget ' . $container_class . '">';
		$after_widget = '</div></div>';
	...
	function mce_external_plugins( $plugins ) {
		$plugins['widgetShortcode'] = get_template_directory_uri() . '/plugins/widget-shortcode/assets/tinymce.js';
	...
	function editor_parameters() {
		...
		wp_localize_script( 'editor', 'widgetShortcode', array(
			'title' => __( 'Toplist Shortcode', 'widget-shortcode' ),
			'widgets' => $widgets,
			'image' => get_template_directory_uri() . '/plugins/widget-shortcode/assets/widget-icon.png',
		) );
	}
}
