...
add_action( "widgets_init", "big_top_list_class_name_widget" );

function big_top_list_class_name_widget() {register_widget( "big_top_list_class_name" );}
            ...
            class big_top_list_class_name extends WP_Widget {


               function __construct() {
                  parent::__construct(
                    "big_top_list_id_name", // Widget ID
                    "Big Top List",  //Name
      ...
      wp_enqueue_style("big_top_list", get_stylesheet_directory_uri() . "/widgets/big_top_list/big_top_list.css");
      wp_enqueue_script("big_top_list_script", get_stylesheet_directory_uri() . "/widgets/big_top_list/big_top_list.js", array("jquery"));
     ...
     <div class="vertical-top-list-buttons col-12 btn-group-justified" data-toggle="buttons">
      ...
      if( have_rows("manual_repeater", "widget_" . $this->id ) ):
         while ( have_rows("manual_repeater", "widget_" . $this->id ) ) : the_row();
            ...
            include( locate_template( "widgets/big_top_list/big_top_list_html.php", false, false ) );

        endwhile;
      endif;

      if( have_rows("horizontal_manual_repeater", "widget_" . $this->id ) ):
         while ( have_rows("horizontal_manual_repeater", "widget_" . $this->id ) ) : the_row();

            include( locate_template( "widgets/big_top_list/big_top_list_horizontal_html.php", false, false ) );
      ...
      if( have_rows("horizontal_manual_repeater_tab2", "widget_" . $this->id ) ):
         while ( have_rows("horizontal_manual_repeater_tab2", "widget_" . $this->id ) ) : the_row();
      ...
      if( have_rows("manual_repeater_tab3", "widget_" . $this->id ) ):
        ...
        endwhile;
      endif;      if( have_rows("horizontal_manual_repeater_tab3", "widget_" . $this->id ) ):
         while ( have_rows("horizontal_manual_repeater_tab3", "widget_" . $this->id ) ) : the_row();
      ...
      if( have_rows("manual_repeater_tab4", "widget_" . $this->id ) ):
        ...
        endwhile;
      endif;      if( have_rows("horizontal_manual_repeater_tab4", "widget_" . $this->id ) ):
         while ( have_rows("horizontal_manual_repeater_tab4", "widget_" . $this->id ) ) : the_row();
