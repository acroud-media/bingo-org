...
function embed_widget() {register_widget( 'embed_vid_bingo' );}

class embed_vid_bingo extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'embed_vid_widget_bingo', // Widget ID
			esc_html__('Video', 'bingo'), // Name
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'link_to_vid' )); ?>">
		<?php esc_html_e('Link your video', 'bingo'); ?>
	</label>
