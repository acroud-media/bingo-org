...
function img_feat_widget() {register_widget( 'img_feat_cat_bingo' );}

class img_feat_cat_bingo extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'img_featured_category_bingo', // Widget ID
			esc_html__('Big Featured Images', 'bingo'),  //Name
...
if($navigation) {
		...
		<li <?php post_class((is_sticky()?'sticky':'')); ?>>
			<div class="img-featured-posts-image">
				...
				<?php the_post_thumbnail('bingomediumimagefeatured');if ( 'video' == get_post_format() ): echo '<span class="play-icon"></span>'; endif; ?>
				</a>
				<?php }else{ ?>
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
				<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/fallback/big.jpg" loading="lazy" alt="big image"/>
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'display_text' )); ?>">
		<?php esc_html_e('Show content text:', 'bingo'); ?>
	</label>
