...
function social_widget() {register_widget( 'social_widget_bingo' );}

class social_widget_bingo extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'social_bingo', // Widget ID
			__('Social Widget', 'bingo'), // Name
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'facebook_page_url' )); ?>">
		<?php _e('Facebook page url:', 'bingo'); ?>
	</label>
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>">
		<?php _e('Pinterest page url:', 'bingo'); ?>
	</label>
